...
if __name__ == '__main__':
    ...
    train_dataset = MsrPCDataset(split = 'train', augment=False)
    val_dataset = MsrPCDataset(split = 'val', augment=False)

    '''
    N = 20000
    train_dataset = ParaphraseDataset(split = 'train', mode = 'tapaco', N=N)
    val_dataset   = ParaphraseDataset(split = 'val', mode = 'tapaco', N=N)
    '''
